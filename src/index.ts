...
// Get a list of workspaces using the provided API endpoint with OAuth2 authentication
server.tool(
  "get_workspaces",
  "Get a list of workspaces using the provided API endpoint with OAuth2 authentication",
  async () => {
...
// Get a list of projects using the provided API endpoint with OAuth2 authentication
server.tool(
  "get_projects",
  "Get a list of projects using the provided API endpoint with OAuth2 authentication",
  async () => {
    ...
    const endpoint = "https://testapi.dev.getbusy.com/api/v1/project";
    try {
      const res = await fetch(endpoint, {
        method: "GET",
        headers: {
